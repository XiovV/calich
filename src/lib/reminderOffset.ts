...
export function reminderChannelOptions(
  emailAvailable: boolean,
): ReminderChannelOption[] {
  const options: ReminderChannelOption[] = [
...
/** The unit dropdown options for a Reminder offset entry. */
export const REMINDER_OFFSET_UNIT_OPTIONS: {
...
export function normalizeCustomOffset(
  amount: number,
...
export function splitCustomOffset(offsetMinutes: number): {
  amount: number;
  unit: ReminderOffsetUnit;
} {
